            ...
            <div class="main_menu">
            	<nav class="navbar navbar-expand-lg navbar-light">
					<div class="container">
						...
						<a class="navbar-brand logo_h" href="index.php"><h1>Yabatech Project Repository</h1></a>
						...
						<div class="collapse navbar-collapse offset" id="navbarSupportedContent">
							<ul class="nav navbar-nav menu_nav ml-auto">
								<li class="nav-item <?php echo " ".$activeindex;?>"><a class="nav-link" href="index.php">Home</a></li>  
								<li class="nav-item <?php echo  " ".$activeprojects;?>"><a class="nav-link" href="projects.php">Projects</a></li> 
