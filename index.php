            ...
            <div class="banner_inner d-flex align-items-center">
				...
				<div class="container">
					<div class="banner_content text-center">
						<h3>Check our repository <br />for recently approved projects for computer scientists</h3>
						<p>project -Repo contains complete and approved projects from several students in the departmemt history.</p>
        			...
        			<div class="col-lg-3 col-sm-6">
        				<div class="finance_item">
        					<div class="media">
        						...
        						<div class="media-body">
        							<h5>Fuzzy Logic & <br />Data Science</h5>
        						</div>
        					</div>
        				</div>
        			</div>
        			<div class="col-lg-3 col-sm-6">
        				<div class="finance_item">
        					<div class="media">
        						...
        						<div class="media-body">
        							<h5>Hard ware<br />Implementations</h5>
        						</div>
        					</div>
        				</div>
        			</div>
        		...
        		<div class="row latest_blog_inner">
        			<div class="col-lg-3 col-md-6">
        				<div class="l_blog_item"><!-- 
        					...
        					<a class="date" href="#">25 October, 2018  |  By Tolu Sodehinde F/HD/16/32110007</a>
        					<a href="single-blog.html"><h4>Design and Implementation of an online customer management system using AI </h4></a>
        					<p>AI has a wide range of applications cutting across all fields of human leaning. This project implements AI in identifying customer needs based on their shopping experiences on an e-commerce web application</p>
        				</div>
        			</div>
        			<div class="col-lg-3 col-md-6">
        				<div class="l_blog_item">
        ...
        <section class="impress_area p_120">
        	<div class="container">
        		<div class="impress_inner text-center">
					...
					<a class="main_btn2" href="signup.php">Sign up as a student</a>
        		</div>
        	</div>
        </section>
        <!--================End Impress Area =================-->
